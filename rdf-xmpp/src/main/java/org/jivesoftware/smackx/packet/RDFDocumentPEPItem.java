...
import net.fortytwo.flow.rdf.xmpp.RDFDocument;
import net.fortytwo.flow.rdf.xmpp.SesameStream;
import net.fortytwo.flow.rdf.xmpp.Testing;
...
public class RDFDocumentPEPItem extends PEPItem {
    ...
    private static final String NAMESPACE = SesameStream.NAMESPACE;
