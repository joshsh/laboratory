...
/**
 * Preliminary results:
 *     XMPP Beijing <--> EC2_EastCoast:  540.62 ms/trip (for 100 round-trips)
 *     XMPP EC2_EastCoast <--> Beijing:  516.98
 *     XMPP Oakland <--> EC2_EastCoast:  156.53
 *     XMPP EC2_eastCoast <--> Oakland:  161.03
 *     XMPP Beijing <--> Oakland:        551.67
 *     XMPP Oakland <--> Beijing:        575.59
 *     XMPP EC2_EastCoast (<--> self):   103.99
 *     XMPP localhost (<--> self, on EC2): hangs...
 *
 * User: josh
 * Date: Dec 28, 2010
 * Time: 10:02:49 PM
...
public class TimerAgent extends Agent {
    ...
    protected void setup() {
        System.out.println("timer service (" + this.getAID().getName() + ") is available here:");
...
//            dictation.addAddresses("http://127.0.0.1:54542/acc");
            ...
            System.out.println("dictation test message sent: \n" + m);
        } catch (Throwable t) {
