 ...
 * Time: 3:01:08 PM
 */
public class RDFSpreadVector implements WeightedVectorApproximation<Resource, PataException> {
    ...
    public void stepRelated(final SailConnection sc,
        ...
        if (0 < inPredicates.length) {
            Handler<Resource, PataException> inHandler = new Handler<Resource, PataException>() {
        ...
        if (0 < outPredicates.length) {
            Handler<Resource, PataException> outHandler = new Handler<Resource, PataException>() {
                public boolean handle(final Resource r) throws PataException {
